...
signal
	...
	{ $$ = new yy.parser.Diagram.Signal($1, $2, $3, $4); }
	;

actor
	: ACTOR { $$ = yy.parser.yy.getActor(yy.parser.Diagram.unescape($1)); }
	;

actor_alias
	: ACTOR { $$ = yy.parser.yy.getActorWithAlias(yy.parser.Diagram.unescape($1)); }
	;
...
message
	: MESSAGE { $$ = yy.parser.Diagram.unescape($1.substring(1)); }
	;
